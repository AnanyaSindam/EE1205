...
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/audi.wav
\end{lstlisting}
...
There are a lot of yellow lines between 440 Hz to 5.1KHz. The darker areas are those where the frequencies have very low intensities, and the orange and yellow areas represent frequencies that have high intensities in the sound. These represent the synthesizer key tones. Also, the key strokes are audible along with background noise.\\
\begin{figure}[H]
	\centering
    \includegraphics[width=\columnwidth]{figs/bef.png }
...
\item
The output of the python script in Problem \ref{prob:output} is the audio file audi-filtered.wav. Play the file in the spectrogram in Problem \ref{prob:spectrogram}. What do you observe?
\\
...
\begin{figure}[H]
	\centering
    \includegraphics[width=\columnwidth]{figs/aft.png }
    \caption{Spectrogram of the audio file before Filtering}
...
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/4.4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/5_sol.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/5.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/6.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{-2.63862774}y(n - 1) + \brak{2.76930979}y(n - 2) \nonumber \\
	&- \brak{-1.33928076 }y(n - 3) + \brak{0.24982167 }y(n - 4) \nonumber \\
	&= \brak{2.57643\times 10^{-3}}x(n) + \brak{10.30574 \times 10^{-3}}x(n - 1) \nonumber \\
	&+ \brak{15.45861\times 10^{-3}}x(n - 2) + \brak{10.30574\times 10^{-3}}x(n - 3) \nonumber \\
	&+ \brak{2.57643 \times 10^{-3}}x(n - 4)
\end{align}
...
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/AnanyaSindam/EE1205/blob/main/Audio_Filter/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
