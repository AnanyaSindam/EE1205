...
plt.legend(loc='best', title='Passband and Stopband', labels=['Epsilon = 0.349', 'Epsilon = 0.41', 'Epsilon = 0.54', 'Epsilon = 0.61', 'Passband', 'Stopband'])
plt.grid(True)
